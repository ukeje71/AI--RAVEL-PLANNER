...
export const Products = [
  // APARTMENTS (IDs 1-7)
  {
    ...
    medium4: "Amenities",
    Text4: "Water, Constant Electricity Wifi.",
    medium5: "Host Details",
    Text5: "Hotel Chain – Urban Escape (15 years in business)",
    image: Palour1,
    Price: "$" + 200 + " per night",
    ...
    Followup:
      "Tastefully furnished space ideal for both short and long stays. Comes with a fully equipped kitchen, smart TV, and complimentary airport pickup. Secure, serene, and family-friendly.",
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "Located in the heart of the city with quick access to business hubs. Offers a cozy, self-contained space perfect for solo travelers or couples. Includes daily cleaning and a concierge desk.",
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "Stylishly designed apartment located in a gated estate with 24/7 security. Features include a workstation, smart lighting, Netflix subscription, and nearby access to Lekki Conservation Centre.",
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "Clean, affordable hotel with a panoramic view of the city, complimentary breakfast, and a restaurant serving both local and continental dishes. Ideal for weekend getaways.",
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "Perfect for families and groups. Fully furnished with contemporary Nigerian art pieces, a large living area, and a hill-view balcony. Close to Enugu mall and local markets.",
    location: "Victoria Island",
    rating: 4.8,
    icon1: KeyRound,
    icon2: BedDouble,
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "Nestled along the Calabar waterfront, this stylish suite offers a peaceful escape for both business and leisure travelers. It features floor-to-ceiling windows, a serene color palette, fast Wi-Fi, and a private balcony with views of the marina. Ideal for solo guests or couples seeking quiet luxury.",
    location: "Victoria Island",
    rating: 4.8,
    icon1: KeyRound,
    icon2: BedDouble,
  ...
  },
  {
    ...
    Remarks: "About this place",
    Followup:
      "This modern 2-bedroom apartment is located in a secure estate and offers a minimalist aesthetic with spacious rooms, full kitchen amenities, and dedicated workspaces. Perfect for families or remote workers visiting Asaba, with easy access to shopping and transportation.",
    location: "Victoria Island",
    rating: 4.8,
    icon1: KeyRound,
    icon2: BedDouble,
  ...
  // AIRLINES (IDs 8-14)
  {
    ...
    Medium3: "Highlights",
    Text3:
      "5-star Skytrax airline One of the best long-haul travel experiences Doha layover tours & visa-free stopovers",
    image: Emirate1,
    Price: 2500,
    ...
    Remarks: "Overview",
    Followup:
      "IATA Code: QR Headquarters: Doha, Qatar Hub: Hamad International Airport Fleet: Airbus A350, Boeing 777, 787 Coverage: 150+ global destinations",
